...
void BitcoinGUI::createActions()
{
    ...
    openAction->setStatusTip(tr("Open a junkcoin: URI or payment request"));

    importPrivateKeyAction = new QAction(platformStyle->TextColorIcon(":/icons/address-book"), tr("&Import Private Key..."), this);
    importPrivateKeyAction->setStatusTip(tr("Import a JunkCoin private key"));

    showHelpMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible JunkCoin command-line options").arg(tr(PACKAGE_NAME)));
...
{
    QString strTitle = tr("JunkCoin"); // default title
