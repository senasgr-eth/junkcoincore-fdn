...
/** Recommended transaction fee by Junkcoin Core developers
  *
  * All fee defaults used throughout the client derive their
  * value from this base default.
  */
static const CAmount RECOMMENDED_MIN_TX_FEE = 100000;
 ...
 *
 *  junkcoin:    Increment mempool limits and accept RBF in steps of 0.0001 JKC
...
/**
 * junkcoin: Default dust limit that is evaluated when considering whether a
...
/**
 * junkcoin: Default hard dust limit that is evaluated when considering whether
