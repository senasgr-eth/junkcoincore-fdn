...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s junkcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  junkcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded junkcoin transaction") + "\n" +
              "  junkcoin-tx [options] -create [commands]   " + _("Create hex-encoded junkcoin transaction") + "\n" +
              "\n";
